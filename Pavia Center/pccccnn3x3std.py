...
class ConvNet(torch.nn.Module):
    def __init__(self, num_classes):
        ...
        self.layer3 = torch.nn.Linear(20*185, 100)
...
device = 'cpu'
'''
images = sio.loadmat('./hyperspectral_datas/Pavia')['pavia']
labels = sio.loadmat('./hyperspectral_datas/Pavia_gt')['pavia_gt']

zero145_145 = np.zeros([1096,715])
images = np.insert(images,102, zero145_145, 2)

new_images = np.zeros([1096,715,103])
...
#sio.savemat('./hyperspectral_datas/Pavia3x3std.mat',{'pavia':images})'''
images = sio.loadmat('./hyperspectral_datas/Pavia3x3std.mat')['pavia']
labels = sio.loadmat('./hyperspectral_datas/Pavia_gt')['pavia_gt']
