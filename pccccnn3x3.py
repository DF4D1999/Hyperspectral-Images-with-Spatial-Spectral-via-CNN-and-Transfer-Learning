...
class ConvNet(torch.nn.Module):
    def __init__(self, num_classes):
        ...
        self.layer1 = torch.nn.Conv1d(1, 20, kernel_size=11, stride=1, padding=0, bias=True)#ks=24,output=201
        self.layer2 = torch.nn.BatchNorm1d(20)
        self.layer3 = torch.nn.Linear(1860, 100)
...
images = images.reshape((783640,1,103))
