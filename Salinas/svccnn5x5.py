...
sio.savemat('./hyperspectral_datas/salina/data/Salinas_corrected5x5.mat',{'salinas_corrected':images})'''
images = sio.loadmat('./hyperspectral_datas/salina/data/Salinas_corrected5x5')['salinas_corrected']
labels = sio.loadmat('./hyperspectral_datas/salina/data/Salinas_gt')['salinas_gt']
