...
class ConvNet(torch.nn.Module):
    def __init__(self, num_classes):
        ...
        self.layer1 = torch.nn.Conv1d(1, 20, kernel_size=48, stride=1, padding=0, bias=True)#ks=48,output=401
        self.layer2 = torch.nn.BatchNorm1d(20)
        self.layer3 = torch.nn.Linear(8020, 100)#401*20 = 8020
...
#sio.savemat('./hyperspectral_datas/salina/data/Salinas_corrected3x3std.mat',{'salinas_corrected':images})
images = sio.loadmat('./hyperspectral_datas/salina/data/Salinas_corrected3x3std')['salinas_corrected']
labels = sio.loadmat('./hyperspectral_datas/salina/data/Salinas_gt')['salinas_gt']
